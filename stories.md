...
---
<h1 class="title">{{ page.title }}<a href="/feed/stories.xml" title="RSS feed for all literature titles (minus comics)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-rss-fill" viewBox="0 0 16 16">
  <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm1.5 2.5c5.523 0 10 4.477 10 10a1 1 0 1 1-2 0 8 8 0 0 0-8-8 1 1 0 0 1 0-2m0 4a6 6 0 0 1 6 6 1 1 0 1 1-2 0 4 4 0 0 0-4-4 1 1 0 0 1 0-2m.5 7a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3"/>
</svg></a></h1>
<div class="alert alert-info" role="alert">All the projects below belong to me. Don't copy, repost or use them for AI training.<br>
  <b>Disclaimer:</b> Remember to check the ratings/content warnings before reading my stories.
</div>

<h2 class="title" id="literature"> Literature</h2>
<hr>
  <div class="story-cont"><a href="/stories/the-snake-queen/summary"><img src="/static/image/stories/tsq-2026-cover.webp" class="story-img" alt="The Snake Queen cover image."></a>
    <b>Title:</b> The Snake Queen<br>
  ...
  <div class="progress-bar" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">100%</div>
        ...
        <br>
          <p style="text-align: right; vertical-align: middle;"><a href="https://the-snake-queen.cfw.me/">Read of ComicFury</a>&nbsp;&nbsp;<b><button class="button button-stories"><a href="/stories/the-snake-queen/summary">Read here <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
  <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
</svg></a></button></b></p></div>
  ...
  <div class="progress-bar" role="progressbar" style="width: 11%" aria-valuenow="11" aria-valuemin="0" aria-valuemax="100">11%</div>
        ...
        <br>
          <p style="text-align: right"><a href="https://little-star-and-the-city-of-wonders.cfw.me/">Read of ComicFury</a>&nbsp;&nbsp;<b><button class="button button-stories"><a href="/stories/little-star-and-the-city-of-wonders/summary">Read here <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
  <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
</svg></a></button></b></p></div>
...
The episodes follow the early life of a silly danger noodle originally named Fang before it befriended goddess Raa and had its tail in the creation of a new legend.<br>
        <br>
          <p style="text-align: right"><a href="https://feng-before-dusk.thecomicseries.com/">Read of ComicFury</a>&nbsp;&nbsp;<b><button class="button button-stories"><a href="/stories/feng-before-dusk/summary">Read here <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
  <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
</svg></a></button></b></p></div>
