...
<h1 class="title">{{ page.title }}<a href="/feed/pixelarts.xml"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-rss-fill" viewBox="0 0 16 16">
